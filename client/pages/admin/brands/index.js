      ...
      render: (_, brand) => (
        <>
          <div className='flex items-center gap-4'>
            <UpdateBrands updateFunction={updateFunction} brand={brand} />
            <DeleteModal id={brand?._id} deleteFun={deleteHandler} deleteBtn={<DeleteOutlined style={{ verticalAlign: "middle" }} />} />
          </div>
        </>
      ),
    },
      ...
      <div className={styles.brands}>
        ...
        <div className='flex justify-end gap-4 my-4'>
          <div className={styles.manageBrands}>
            <CreateBrands updateFunction={updateFunction} />
          </div>
        </div>
        {/* Show brands */}
