                ...
                user.save((err, result) => {
                    ...
                    if (result) {
                        ...
                        if (process.env.NODE_ENV === 'production') {
                            url = `https://Shah Parts.com/reset-password/${token}` // The url of the domain on which you are hosting your frontend in production mode to serve the reset-password link page by sending this link to the email
                        } else {
